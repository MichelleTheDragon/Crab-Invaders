...
class SpriteRenderer(Component):
    ...
    def Draw(self):
        GameWorld.instance.screen.blit(self.sprite_image, (self.gameObject.transform.posX - self.sprite.rect.x/2, self.gameObject.transform.posY - self.sprite.rect.y/2))